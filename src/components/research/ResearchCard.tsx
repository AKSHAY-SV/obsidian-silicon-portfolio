...
export default function ResearchCard({
  ...
  const displayTags = pub.technologyTags || pub.tags || [];

  const handleCopy = () => {
    const citationText = `${pub.author}, "${pub.title}," Published in ${pub.source}, ${displayDate}.`;
      ...
      <div className="p-6 md:p-8 space-y-4">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-2">
            ...
            <span className="font-mono text-[10px] text-slate-500">{pub.source} • {displayDate}</span>
          </div>
